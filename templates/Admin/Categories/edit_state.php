        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('name',['label'=>'State']) ?></th>
            ...
            <tbody>
                ...
                <tr id="<?=$category->id?>">
                    ...
                    <td id="statename<?=$category->id?>"><?= h($category->name) ?></td>
                    <td class="actions">
                        <!-- Modal button -->
                              ...
                              <div class="modal-body">
                                ...
                                <?= $this->Form->create() ?>
                                    <div class="form-group">
                                        ...
                                        <div id="error_name<?=$category->id?>" class="text-danger" ></div>
        ...
        if ($.trim($('#name'+categoryid).val()).length !=0) {
            ...
            $.ajax({
                ...
                {    
                    ...
                    $('#statename'+categoryid).html(categoryname);
            ...
            $('#error_name'+categoryid).html('*State name required!');
        }        
    }
    $('.edit').click(function(){
            return false;
